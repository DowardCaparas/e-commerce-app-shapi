    ...
    <Fragment>
      <div className="md:p-6 mb-36">
        ...
        {cart.length > 0 ? (
         ...
         {/* Order summary */}
      {cart.length > 0 && (
        <div className="flex flex-col bg-white md:px-5 md:py-6 p-4 fixed md:bottom-6 left-0 
        right-0 md:left-75 md:right-11 bottom-16 md:rounded-t-2xl border-t md:shadow-lg">
          <h1 className="text-xl font-semibold mb-4 max-md:hidden">
            Order Summary
          </h1>
